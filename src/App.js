        ...
        <div className="auth-inner flex">
          <Routes>
            ...
            <Route path={path.HOME} element={<Home />}>
              ...
              <Route exact path={path.BUYSELL} element={<BuySell />} />
              <Route path={path.PAGE_PERSONAL} element={<PersonalPage />} />
              ...
              <Route
                ...
                element={<Main content={"Cho thuê nhà mặt tiền"} />}
              />
              <Route
              ...
              <Route
                ...
                element={<Main content={"Cho thuê khách sạn"} />}
              />
              <Route
              ...
              <Route
                ...
                element={<Main content={"Cho thuê phòng trọ"} />}
              />
              <Route
                path={path.RENTAL_OFFICE}
                element={<Main content={"Cho thuê văn phòng"} />}
              />
              <Route
              ...
              <Route
                ...
                element={<Main content={"Thuê nhà nguyên căn"} />}
              />
            </Route>
            {/* Private */}
            <Route path={path.PRIVATE} element={<Private />}>
              <Route path={path.PAYMENT_FAIL} element={<PaymentFail />} />
              <Route path={path.MANAGEMENT_PAGE} element={<ManagePost />} />
              <Route path={path.CREATE_POST} element={<CreatePost />} />
              <Route path={path.POST_MANAGEMENT} element={<ManagePost />} />
              <Route path={path.EDIT_INFOR} element={<EditInfor />} />
              <Route path={path.PAYMENT_STATUS} element={<PaymentStatus />} />
              <Route path={path.HISTORY_PAYMENT} element={<PaymentHistory />} />
              <Route path={path.SAVED_POST} element={<SavePost />} />
            </Route>
          </Routes>
        </div>
      </div>
